...
public class LogController2 extends BaseController{
	...
	@ResponseBody
	@RequestMapping(value="/operationloglist1" , method={RequestMethod.POST})
	...
	@RequestMapping(value="/downloginlogexcel1" , method={RequestMethod.GET} )
	...
	@BizLog("清除日志")
	@ResponseBody
	@RequestMapping(value="/clearloginlog1" , method={RequestMethod.POST})
